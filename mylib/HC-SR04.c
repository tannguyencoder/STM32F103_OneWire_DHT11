...
void HCSR04_Init() 
{
		...
		TIM_OCInitStruct.TIM_Pulse = 20; //us
	...
	u16 HCSR04_GetDistance() {
		...
		TIM_ClearFlag(US_TIMER, TIM_FLAG_Update);
		return (TIM_GetCapture2(US_TIMER)-TIM_GetCapture1(US_TIMER))*1/58.824; //////mm
	}
